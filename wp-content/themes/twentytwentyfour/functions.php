...
function custom_youtube_shortcode($atts) {
    ...
    return '<p><iframe class="' .$class . '"  width="' . $width . '" height="' . $height . '" src="https://www.youtube.com/embed/' . $id . '" frameborder="0" allowfullscreen></iframe></p>';
}
